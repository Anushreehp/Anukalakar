        ...
        var addUserAttribute = function(attributeName, attributeValue, attributeType) {
            ...
            try {
                if (!!MOENGAGE_APP_ID && !!Moengage && attributeValue != null && attributeValue != undefined) {
                    localUAData.push({
                        type: !!attributeType ? attributeType : "aua",
                        name: attributeName,
        ...
        var addData = function(dataEvent, dataCustomObj) {
            ...
            try {
                if (!!MOENGAGE_APP_ID && !!dataEvent) {
                    ...
                    var data = {
                        moe_event_name: dataEvent,
                        moe_event_customobj: dataCustomObj
                    };
                    var newStorageData = [];
                            ...
                            if ((!!e && !!e.detail) || isSessionData) {
                                ...
                                try {
                                    ...
                                    if (!!userData.userId) {
                                        ...
                                        userAttributeLSArray.push({
                                            type: "afn",
                                            value: trimTheUAValue(userData.firstName)
                                        });
                                        userAttributeLSArray.push({
                                            type: "aln",
                                            value: trimTheUAValue(userData.lastName)
                                        });
                                        userAttributeLSArray.push({
                                            type: "am",
                                            value: String(!!userData.phoneCode ? userData.phoneCode : "91") + userData.contactNumber
                                        });
                                        ...
                                        if (userMainData.email) {
                                            userAttributeLSArray.push({
                                                type: "ae",
                                                value: trimTheUAValue(userMainData.email)
                                            });
                                        }
                                        userAttributeLSArray.push({
                                            type: "aua",
                                            name: "grade",
                                            value: userMainData.grade || (userMainData.studentInfo && userMainData.studentInfo.grade) || null
                                        });
                                        userAttributeLSArray.push({
                                            type: "aua",
                                            name: "board",
                                            value: userMainData.board || (userMainData.studentInfo && userMainData.studentInfo.board) || null
                                        });
                                        userAttributeLSArray.push({
                                            type: "aua",
                                            name: "target",
                                            value: userMainData.target || (userMainData.studentInfo && userMainData.studentInfo.target) || null
                                        });
                                        userAttributeLSArray.push({
                                            type: "aua",
                                            name: "examTargets",
                                            value: trimTheUAValue(userMainData.examTargets || (userMainData.studentInfo && userMainData.studentInfo.examTargets)) || null
                                        });
                                        ...
                                        userAttributeLSArray.push({
                                            type: "aua",
                                            name: "parentEmails",
                                            value: trimTheUAValue(userMainData.parentEmails) || null
                                        });
                                        userAttributeLSArray.push({
                                            type: "aua",
                                            name: "parentContactNumber",
                                            value: (userMainData.studentInfo && (userMainData.studentInfo.parentContactNo || userMainData.studentInfo.parentContactNumbers)) || null
                                        });
                                        userAttributeLSArray.push({
                                            type: "aua",
                                            name: "parentFirstName",
                                            value: (userMainData.studentInfo && trimTheUAValue(userMainData.studentInfo.parentFirstName)) || null
                                        });
