...
function(t, e) {
    ...
    }, t._tfa.config = new t._tfa.TfaConfig, t._taboola = t._taboola || []), t._tfa.config.addConfig(1358358, {
        "tfa:event-host-map": {
...
function(t, e, i) {
    ...
    bakedPublisherId: 1358358,
    bakedPublisherName: 'vedantu-sc',
    tblVersion: "20220109-1-RELEASE",
...
function(t, e) {
    ...
    function j() {
        s.initialized || n.config.safeGet("tfa:engagement:is-manager-disabled", !1, 1358358) || (r = n.TUP || {}, s.initialized = !0, s.ESU.init(D), d.init(), h.init(o), M(), s.ESU.getIsLocalStorageAvailable() && (f.init(o), u.init(o, h, d), a.init(o, h), c.init(o, h, e.sharedEvents.PAGE_VIEW), l.init(o, h, f), s.initIntervalTrigger()), x(p, m, N, U))
    }
...
function(t, e, i) {
    ...
    function $(t) {
        if (o.SSD) {
            ...
            o.SSD.isURLVisited(n) || i++, t.ssd = i
        }
    }
...
function(t, e, i) {
    ...
    function v() {
        var e, i, n, r;
        if (n = t._tfa.config.safeGet("tfa:get-publisher-id-from-baker", !1) && h ? 1358358 : R())
