    ...
    return function e(n, t, r) {
        ...
        1: [function(e, n, t) {
            (function(e) {
                ...
                function t() {
                    f = !0;
                    for (var e, n, t = s.length; t;) {
                        for (n = s, s = [], e = -1; ++e < t;) n[e]();
                        t = s.length
                    }
                    f = !1
                }
                var r, o = e.MutationObserver || e.WebKitMutationObserver;
                if (o) {
                    var i = 0,
                        a = new o(t),
        ...
        2: [function(e, n, t) {
            ...
            n.exports = o, o.prototype.catch = function(e) {
                ...
                if ("function" != typeof e && this.state === h || "function" != typeof n && this.state === l) return this;
                var t = new this.constructor(r);
                return this.state !== v ? a(t, this.state === h ? e : n, this.outcome) : this.queue.push(new i(t, e, n)), t
                ...
                for (var a = new Array(o), c = 0, u = -1, f = new this(r); ++u < o;) n(e[u], u);
                return f
            }, o.race = function(e) {
                function n(e) {
                    t.resolve(e).then(function(e) {
                ...
                var o = e.length,
                    i = !1;
                if (!o) return this.resolve([]);
                for (var a = -1, c = new this(r); ++a < o;) n(e[a]);
                return c
            }
        }, {
            1: 1
        ...
        4: [function(e, n, t) {
            ...
            function u(e) {
                return "boolean" == typeof R ? j.resolve(R) : function(e) {
                    return new j(function(n) {
                        var t = e.transaction(C, x),
                            o = r([""]);
                        t.objectStore(C).put(o, "key"), t.onabort = function(e) {
            ...
            function l(e, n) {
                return new j(function(t, r) {
                    ...
                    n && (i.onupgradeneeded = function(n) {
                        var t = i.result;
                        try {
                            t.createObjectStore(e.storeName), n.oldVersion <= 1 && t.createObjectStore(C)
                        } catch (t) {
            ...
            function b(e, n, t, r) {
                ...
                try {
                    ...
                    if (r > 0 && (!e.db || "InvalidStateError" === o.name || "NotFoundError" === o.name)) return j.resolve().then(function() {
                        if (!e.db || "NotFoundError" === o.name && !e.db.objectStoreNames.contains(e.storeName) && e.version <= e.db.version) return e.db && (e.version = e.db.version + 1), v(e)
                    }).then(function() {
                        return function(e) {
                            f(e);
                            for (var n = B[e.name], t = n.forages, r = 0; r < t.length; r++) {
                                var o = t[r];
                                o._dbInfo.db && (o._dbInfo.db.close(), o._dbInfo.db = null)
                            }
                            return e.db = null, h(e).then(function(n) {
            ...
            function _(e) {
                ...
                var f = new ArrayBuffer(a),
                    s = new Uint8Array(f);
                for (n = 0; n < c; n += 4) t = L.indexOf(e[n]), r = L.indexOf(e[n + 1]), o = L.indexOf(e[n + 2]), i = L.indexOf(e[n + 3]), s[u++] = t << 2 | r >> 4, s[u++] = (15 & r) << 4 | o >> 2, s[u++] = (3 & o) << 6 | 63 & i;
                return f
            }
            ...
            function I(e) {
                var n, t = new Uint8Array(e),
                    r = "";
                for (n = 0; n < t.length; n += 3) r += L[t[n] >> 2], r += L[(3 & t[n]) << 4 | t[n + 1] >> 4], r += L[(15 & t[n + 1]) << 2 | t[n + 2] >> 6], r += L[63 & t[n + 2]];
            ...
            function E(e, n, t, r, o, i) {
                e.executeSql(t, r, o, function(e, a) {
                    a.code === a.SYNTAX_ERR ? e.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name = ?", [n.storeName], function(e, c) {
                        c.rows.length ? i(e, a) : w(e, n, function() {
            ...
            function D() {
                for (var e = 1; e < arguments.length; e++) {
                    var n = arguments[e];
                    if (n)
                        for (var t in n) n.hasOwnProperty(t) && (ce(n[t]) ? arguments[0][t] = n[t].slice() : arguments[0][t] = n[t])
                }
                return arguments[0]
            }
            ...
            var j = Promise,
                ...
                k = {
                    ...
                    _initStorage: function(e) {
                        ...
                        i || (i = {
                            ...
                            dbReady: null,
                            deferredOperations: []
                        }, B[r.name] = i), i.forages.push(t), t._initReady || (t._initReady = t.ready, t.ready = y);
                        for (var a = [], c = 0; c < i.forages.length; c++) {
                            var u = i.forages[c];
                            u !== t && a.push(u._initReady().catch(n))
                        }
                        var f = i.forages.slice(0);
                        return j.all(a).then(function() {
                            return r.db = i.db, h(r)
                        }).then(function(e) {
                            return r.db = e, p(r, t._defaultConfig.version) ? v(r) : e
                        }).then(function(e) {
                    ...
                    iterate: function(e, n) {
                        var t = this,
                            r = new j(function(n, r) {
                                t.ready().then(function() {
                                    b(t._dbInfo, P, function(o, i) {
                                        if (o) return r(o);
                                        try {
                    ...
                    setItem: function(e, n, t) {
                        var r = this;
                        e = a(e);
                        var i = new j(function(t, o) {
                            var i;
                            r.ready().then(function() {
                                return i = r._dbInfo, "[object Blob]" === M.call(n) ? u(i.db).then(function(e) {
                    ...
                    clear: function(e) {
                        var n = this,
                            t = new j(function(e, t) {
                                n.ready().then(function() {
                                    b(n._dbInfo, x, function(r, o) {
                                        if (r) return t(r);
                                        try {
                                    ...
                                    b(t._dbInfo, P, function(o, i) {
                                        ...
                                        try {
                                            ...
                                            u.onsuccess = function() {
                                                var t = u.result;
                                                t ? 0 === e ? n(t.key) : c ? n(t.key) : (c = !0, t.advance(e)) : n(null)
                                            }, u.onerror = function() {
                                                r(u.error)
                                            }
                                        } catch (e) {
                    ...
                    dropInstance: function(e, n) {
                        ...
                        if ((e = "function" != typeof e && e || {}).name || (e.name = e.name || r.name, e.storeName = e.storeName || r.storeName), e.name) {
                            var i = e.name === r.name && this._dbInfo.db ? j.resolve(this._dbInfo.db) : h(e).then(function(n) {
                                var t = B[e.name],
                                    r = t.forages;
                                t.db = n;
                            ...
                            t = e.storeName ? i.then(function(n) {
                                if (n.objectStoreNames.contains(e.storeName)) {
                                    ...
                                    return new j(function(n, r) {
                                        ...
                                        throw (d(e, n) || j.resolve()).catch(function() {}), n
                                    })
                                }
                            }) : i.then(function(n) {
                                f(e);
                                ...
                                return new j(function(n, t) {
                                    ...
                                    t.db = e;
                                    for (var n = 0; n < r.length; n++) s(r[n]._dbInfo)
                                }).catch(function(n) {
                                    throw (d(e, n) || j.resolve()).catch(function() {}), n
                                })
                            })
                        } else t = j.reject("Invalid arguments");
                        return o(t, n), t
                    }
                },
                ...
                te = {
                    serialize: function(e, n) {
                        var t = "";
                        if (e && (t = ne.call(e)), e && ("[object ArrayBuffer]" === t || e.buffer && "[object ArrayBuffer]" === ne.call(e.buffer))) {
                            var r, o = U;
                            e instanceof ArrayBuffer ? (r = e, o += z) : (r = e.buffer, "[object Int8Array]" === t ? o += X : "[object Uint8Array]" === t ? o += J : "[object Uint8ClampedArray]" === t ? o += Y : "[object Int16Array]" === t ? o += H : "[object Uint16Array]" === t ? o += Q : "[object Int32Array]" === t ? o += K : "[object Uint32Array]" === t ? o += G : "[object Float32Array]" === t ? o += $ : "[object Float64Array]" === t ? o += Z : n(new Error("Failed to get type for BinaryArray"))), n(o + I(r))
                        } else if ("[object Blob]" === t) {
                            var i = new FileReader;
                            i.onload = function() {
                                var t = F + e.type + "~" + I(this.result);
                                n(U + V + t)
                    ...
                    deserialize: function(e) {
                        if (e.substring(0, q) !== U) return JSON.parse(e);
                        var n, t = e.substring(ee),
                            o = e.substring(q, ee);
                        if (o === V && W.test(t)) {
                            var i = t.match(W);
                ...
                re = {
                            ...
                            r = new j(function(n, r) {
                                t.ready().then(function() {
                                    ...
                                    o.db.transaction(function(t) {
                                        E(t, o, "SELECT * FROM " + o.storeName, [], function(t, r) {
                                            for (var i = r.rows, a = i.length, c = 0; c < a; c++) {
                                                var u = i.item(c),
                                                    f = u.value;
                                                if (f && (f = o.serializer.deserialize(f)), void 0 !== (f = e(f, u.key, c + 1))) return void n(f)
                                            }
                                            n()
                                        }, function(e, n) {
                                            r(n)
                    ...
                    getItem: function(e, n) {
                        ...
                        var r = new j(function(n, r) {
                            t.ready().then(function() {
                                var o = t._dbInfo;
                                o.db.transaction(function(t) {
                                    E(t, o, "SELECT * FROM " + o.storeName + " WHERE key = ? LIMIT 1", [e], function(e, t) {
                    ...
                    setItem: function(e, n, t) {
                        return function e(n, t, r, i) {
                            var c = this;
                            n = a(n);
                            var u = new j(function(o, a) {
                                c.ready().then(function() {
                                    void 0 === t && (t = null);
                                    var u = t,
                                        f = c._dbInfo;
                                    f.serializer.serialize(t, function(t, s) {
                                        s ? a(s) : f.db.transaction(function(e) {
                                            E(e, f, "INSERT OR REPLACE INTO " + f.storeName + " (key, value) VALUES (?, ?)", [n, t], function() {
                                                o(u)
                                            }, function(e, n) {
                                                a(n)
                                            })
                                            ...
                                            if (t.code === t.QUOTA_ERR) {
                                                if (i > 0) return void o(e.apply(c, [n, u, r, i - 1]));
                                                a(t)
                                            }
                                        })
                                    })
                    ...
                    removeItem: function(e, n) {
                        ...
                        var r = new j(function(n, r) {
                            t.ready().then(function() {
                                var o = t._dbInfo;
                                o.db.transaction(function(t) {
                                    E(t, o, "DELETE FROM " + o.storeName + " WHERE key = ?", [e], function() {
                                        n()
                                    }, function(e, n) {
                                        r(n)
                                    })
                            ...
                            t = new j(function(e, t) {
                                n.ready().then(function() {
                                    ...
                                    r.db.transaction(function(n) {
                                        E(n, r, "DELETE FROM " + r.storeName, [], function() {
                                            e()
                                        }, function(e, n) {
                                            t(n)
                                        })
                        ...
                        var n = this,
                            t = new j(function(e, t) {
                                n.ready().then(function() {
                                    var r = n._dbInfo;
                                    r.db.transaction(function(n) {
                                        E(n, r, "SELECT COUNT(key) as c FROM " + r.storeName, [], function(n, t) {
                        ...
                        var t = this,
                            r = new j(function(n, r) {
                                t.ready().then(function() {
                                    var o = t._dbInfo;
                                    o.db.transaction(function(t) {
                                        E(t, o, "SELECT key FROM " + o.storeName + " WHERE id = ? LIMIT 1", [e + 1], function(e, t) {
                        ...
                        var n = this,
                            t = new j(function(e, t) {
                                n.ready().then(function() {
                                    var r = n._dbInfo;
                                    r.db.transaction(function(n) {
                                        E(n, r, "SELECT key FROM " + r.storeName, [], function(n, t) {
                    ...
                    dropInstance: function(e, n) {
                        ...
                        var r, i = this;
                        return o(r = e.name ? new j(function(n) {
                            var r;
                            r = e.name === t.name ? i._dbInfo.db : openDatabase(e.name, "", "", 0), n(e.storeName ? {
                                db: r,
                            ...
                            return new j(function(n, t) {
                                e.db.transaction(function(r) {
                                    ...
                                    for (var i = [], a = 0, c = e.storeNames.length; a < c; a++) i.push(o(e.storeNames[a]));
                                    j.all(i).then(function() {
                                        n()
                                    }).catch(function(e) {
                                        t(e)
                                    })
                        ...
                        }) : j.reject("Invalid arguments"), n), r
                    }
                },
                oe = {
                    ...
                    _initStorage: function(e) {
                        ...
                        return n.keyPrefix = S(e, this._defaultConfig), N() ? (this._dbInfo = n, n.serializer = te, j.resolve()) : j.reject()
                    },
                    _support: function() {
                        try {
                    ...
                    iterate: function(e, n) {
                        var t = this,
                            r = t.ready().then(function() {
                                for (var n = t._dbInfo, r = n.keyPrefix, o = r.length, i = localStorage.length, a = 1, c = 0; c < i; c++) {
                                    var u = localStorage.key(c);
                                    if (0 === u.indexOf(r)) {
                                        var f = localStorage.getItem(u);
                                        if (f && (f = n.serializer.deserialize(f)), void 0 !== (f = e(f, u.substring(o), a++))) return f
                                    }
                                }
                            });
                        return o(r, n), r
                    ...
                    dropInstance: function(e, n) {
                        ...
                        var r, i = this;
                        return o(r = e.name ? new j(function(n) {
                            n(e.storeName ? S(e, i._defaultConfig) : e.name + "/")
                        }).then(function(e) {
                ...
                de = [se.INDEXEDDB._driver, se.WEBSQL._driver, se.LOCALSTORAGE._driver],
                le = ["dropInstance"],
                he = ["clear", "getItem", "iterate", "key", "keys", "length", "removeItem", "setItem"].concat(le),
                ve = {
                    description: "",
                    driver: de.slice(),
                    name: "localforage",
                ...
                pe = new(function() {
                    function e(n) {
                        ...
                        this._defaultConfig = D({}, ve), this._config = D({}, this._defaultConfig, n), this._driverSet = null, this._initDriver = null, this._ready = !1, this._dbInfo = null, this._wrapLibraryMethodsWithReady(), this.setDriver(this._config.driver).catch(function() {})
                    }
                    return e.prototype.config = function(e) {
                        ...
                        var r = new j(function(n, t) {
                            try {
                                ...
                                for (var a = he.concat("_initStorage"), c = 0, u = a.length; c < u; c++) {
                                    var f = a[c];
                                    if ((!ae(le, f) || e[f]) && "function" != typeof e[f]) return void t(i)
                                }! function() {
                                    for (var n = function(e) {
                                            return function() {
                                                var n = new Error("Method " + e + " is not implemented by the current driver"),
                                                    t = j.reject(n);
                                                return o(t, arguments[arguments.length - 1]), t
                                            }
                                ...
                                var s = function(t) {
                                    ue[r] && console.info("Redefining LocalForage driver: " + r), ue[r] = e, fe[r] = t, n()
                                };
                        ...
                        var r = ue[e] ? j.resolve(ue[e]) : j.reject(new Error("Driver not found."));
                        return i(r, n, t), r
                        ...
                        return this._driverSet = u.then(function() {
                            ...
                            return a._dbInfo = null, a._ready = null, a.getDriver(e).then(function(e) {
                                a._driver = e._driver, r(), a._wrapLibraryMethodsWithReady(), a._initDriver = function(e) {
                                    return function() {
                                        var n = 0;
                                        return function t() {
                                            for (; n < e.length;) {
                                            ...
                                            return a._driverSet = j.reject(c), a._driverSet
                                        }()
                                    }
                                }(c)
                            })
                            ...
                            return a._driverSet = j.reject(e), a._driverSet
                        }), i(this._driverSet, n, t), this._driverSet
                        ...
                        for (var e = 0, n = he.length; e < n; e++) O(this, he[e])
...
var MoengageSW = function(e) {
    var n, t, r, o = {
        ...
        i = {
            addReport: function() {
                return o.get() + "/v2/report/add"
            },
            batch: function() {
                return o.get() + "/v2/sdk/report/"
            },
            FCM_END_POINT: "https://fcm.googleapis.com/fcm/send/",
            MOZILLA_END_POINT: "https://updates.push.services.mozilla.com/wpush/v2/"
        };
    const a = 28,
        c = "https://static.skillclash.com/notifications/moe-notification-badge.png",
        u = "WVPG5STCJDMLCEWP2XYQ3XBF";
    ...
    function d(e) {
        e.data && e.data.data && e.data.data.app_id && n.setItem("reportParams", e.data)
    }

    function l(r) {
        if (e.Notification && "granted" === e.Notification.permission) {
            var i;
            t.iterate(function(e, n) {
                const r = Date.now(),
                    o = (r - e.timestamp) / 864e5;
                o > a && t.removeItem(n)
            });
            var f = {};
            r.waitUntil(n.getItem("reportParams").then(function(e) {
                e && e.data && (f = e.data, e.data.environment && o.set(e.data.environment))
            }).then(function() {
                try {
                    var e = r.data.json();
                    if (e) return e
                } catch (e) {
                    console.error("payload not received in Mo Engage Push. Error: ", e)
                }
                ...
                if (n.cid) {
                    if (i = n.cid, await
                        function(e) {
                            return t.length().then(n => {
                                if (0 === n) throw new Error("Existing campaign not present in indexedDB");
                                return t.iterate(function(n, t) {
                                    if (e === t) return !0
                                }).then(e => e)
                            }).catch(() => !1)
                        }(i)) throw new Error(`The campaign ${i} has already been executed.`);
                    var s = {
                        cid: i
                    };
                    a && (s = {
                        ...
                        actions: a.actions,
                        image: a.image,
                        moe_cid_attr: a.moe_cid_attr,
                        timestamp: Date.now()
                    }), t.setItem(i, s)
                }
                if (!a || !a.title || !a.message) return b("MOE_NO_PAYLOAD_WEB", {
                    cid: n.cid
                }, 0), console.error("Moengage - Web Push payload error", err), m("Welcome", {
                    body: "Something unexpected happened",
                    requireInteraction: !1
                });
                try {
                    r = a.moe_cid_attr.moe_campaign_id, o = a.moe_cid_attr.moe_campaign_name
                } catch (e) {
                    throw new Error("cannot get campaign ID or campaign Name.")
                }
                b("NOTIFICATION_RECEIVED_WEB_MOE", {
                    cid: i,
                    moe_campaign_id: r,
                    moe_campaign_name: o,
                    ...a.moe_cid_attr
                }, 1), f.app_id === u && (a.badge = c);
                var d = {
                    body: a.message,
                    icon: a.icon,
                    tag: n.cid || "moe-id",
                    ...
                    requireInteraction: a && !JSON.parse(n.payload.reqInteract) || !1,
                    actions: a.actions,
                    image: a.image
                };
                return function(n, t) {
                    return e.registration.showNotification(n, t)
                }(a.title, d)
            }).catch(function(e) {
                return console.error("Moengage Service Worker Error", e), m("Welcome", {
                    body: "Something unexpected happened",
                    requireInteraction: !1
                })
            }))
    ...
    function h(e) {
        var r, i = e.notification.data;
        e.notification.close();
        var a = Promise.resolve();
        i && ("0" === e.action && i.actions && i.actions instanceof Array && i.actions.length > 0 && i.actions[0].url ? (a = clients.openWindow(i.actions[0].url), r = i.actions[0].title) : "1" === e.action && i.actions && i.actions instanceof Array && i.actions.length > 1 && i.actions[1].url ? (a = clients.openWindow(i.actions[1].url), r = i.actions[1].title) : i.url && (a = clients.openWindow(i.url), r = i.title));
        var c = new Promise(function(e) {
            t.iterate(function(e, n) {
                if (n == i.cid) {
                    var t, o;
                    try {
                        t = e.moe_cid_attr.moe_campaign_id, o = e.moe_cid_attr.moe_campaign_name
                    } catch (e) {
                        throw new Error(e)
                    }
                ...
                console.info("Web Push Campaign clicked: ", n), e()
            })
        });
        e.waitUntil(n.getItem("reportParams").then(function(e) {
            e.data.environment && o.set(e.data.environment)
        }).then(function() {
    ...
    function p(e) {
        var n = e.endpoint;
        return 0 === n.indexOf(i.FCM_END_POINT) ? n.replace(i.FCM_END_POINT, "") : 0 === n.indexOf(i.MOZILLA_END_POINT) ? n.replace(i.MOZILLA_END_POINT, "") : e.subscriptionId
    }

    function m(n, t) {
        return e.registration.showNotification(n, t).then(function() {
            setTimeout(g, 2e3)
        })
    }
    ...
    function g() {
        e.registration.getNotifications().then(function(e) {
            for (var n = 0; n < e.length; ++n) e[n].close()
        })
    }
    ...
    function y(t, r, o) {
        n.getItem("reportParams").then(function(n) {
            var o = n.data;
            o.device_ts = _(), e.registration.pushManager.getSubscription().then(function(e) {
                var n = p(e);
                n ? o.push_id = n : delete o.push_id, delete o.os_platform, o.app_ver = o.app_ver.toString();
                const a = {
                    query_params: o,
                    identifiers: {
                        moe_user_id: "",
                    ...
                    meta: {
                        bid: ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(/[018]/g, e => (e ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> e / 4).toString(16)),
    ...
    function b(t, r, o) {
        n.getItem("reportParams").then(function(n) {
            var a = n.data;
            if ("allowed" === a.isBatchingEnabled) return void y(t, r);
            var c = {
                e: t = {
                    MOE_NO_PAYLOAD_WEB: "MOE_NO_PAYLOAD_WEB",
                    NOTIFICATION_RECEIVED_WEB_MOE: "i",
                    NOTIFICATION_CLICKED_WEB_MOE: "c"
                }[t],
                a: r,
                f: o
            };
            a.device_ts = _(), e.registration.pushManager.getSubscription().then(function(e) {
                var n = p(e);
                n ? a.push_id = n : delete a.push_id, delete a.os_platform;
                var t = function(e, n) {
                    for (var t in e += "?", n) e += t + "=" + n[t] + "&";
                    return e
                }(i.addReport(), a);
                fetch(t, {
                    method: "POST",
    ...
    function _() {
        var e = new Date;
        return Number(Date.UTC(e.getUTCFullYear(), e.getUTCMonth(), e.getUTCDate(), e.getUTCHours(), e.getUTCMinutes(), e.getUTCSeconds(), e.getUTCMilliseconds()))
    }

    function I(e) {
        "moe_offline_data_sync" === e.tag && e.waitUntil(E().then(function(e) {
            console.log(e)
        }))
    }

    function w() {
        return Promise.all([r.getItem("requestMetaData").then(function(e) {
            return e
            ...
            return r.keys().then(function(e) {
                ...
                return new Promise(function() {
                    var t = [];
                    n.map(function(e) {
                        "requestMetaData" !== e && t.push(r.getItem(e))
                ...
                var n = e[0],
                    t = function e(n) {
                        return n.reduce(function(n, t) {
                            return Array.isArray(t) ? n.concat(e(t)) : n.concat(t)
                        }, [])
                    }(e[1]);
                return n.viewsInfo = t, n.viewsCount = t.length, n
            }
        })
    }
    ...
    function E() {
        return new Promise(function(e, n) {
            w().then(function(n) {
                if (n) return fetch(i.batch() + n.query_params.app_id, {
                    method: "POST",
                    body: JSON.stringify(n)
                }).then(function(e) {
                    return e.json()
                }).then(function(n) {
                    if ("success" !== n.status) throw new Error;
                    return r.clear().then(function() {
                        e("successfully replayed failed requests and cleared db")
                    })
                });
                e("No pending requests to replay")
            }).catch(function(e) {
                n("Replaying failed.", e)
            })
        })
    }
    return {
        init: async function() {
            e.addEventListener("install", f), e.addEventListener("activate", s), e.addEventListener("message", d), e.addEventListener("push", l), e.addEventListener("notificationclick", h), e.addEventListener("notificationclose", v), e.addEventListener("sync", I), await async function() {
                return new Promise((e, o) => {
                    n = localforage.createInstance({
                        driver: [localforage.INDEXEDDB],
                        name: "moe_database",
                        storeName: "moe_data"
                    }), t = localforage.createInstance({
                        driver: [localforage.INDEXEDDB],
                        name: "moe_database",
                        storeName: "moe_backup"
                    }), r = localforage.createInstance({
                        driver: [localforage.INDEXEDDB],
                        name: "moe_database",
                        storeName: "offline_data"
                    }), Promise.all([n.ready(), t.ready(), r.ready()]).then(e())
                })
            }(), n.getItem("reportParams").then(function(e) {
                e && e.data && "allowed" === e.data.isBatchingEnabled && E().then(function(e) {
                    console.log(e)
                }).catch(function(e) {
                    console.log(e)
                })
